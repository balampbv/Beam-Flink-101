...
export const DebugLessons: React.FC = () => {
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Debugging Zone</h2>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden transition-colors duration-300">
                <div className="bg-rose-50 dark:bg-rose-900/30 border-b border-rose-100 dark:border-rose-800 p-6">
                ...
                <div className="p-8 flex flex-col md:flex-row gap-12 items-center">
                    ...
                    <div className="flex-1 h-64 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 relative flex items-center justify-center p-4">
                        {/* Pipe Visual */}
                        <div className="absolute inset-x-0 h-16 bg-slate-300 dark:bg-slate-600 rounded overflow-hidden flex items-center">
                            <div className="w-full h-12 border-t border-b border-dashed border-slate-400 dark:border-slate-500 flex justify-between px-2 items-center text-xs text-slate-500 dark:text-slate-300 font-mono">
                                <span>TM 1</span>
                                <span>Network</span>
                                <span>TM 2</span>
                            </div>
                        ...
                        {exploded && (
                            ...
                            >
                                ...
                                <span className="bg-white dark:bg-slate-900 px-2 py-1 rounded shadow text-sm whitespace-nowrap border border-red-200 dark:border-red-800 dark:text-red-400">
